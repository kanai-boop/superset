...
def add_metrics_to_dataset():
    """
    Adds necessary metrics (SUM(clicks), SUM(impressions), etc.) to dataset 32.
    """
    ...
    try:
        ...
        print(f"Adding metrics to dataset {dataset_id}...")
        client.update_dataset(dataset_id, update_payload)
        print("Successfully added metrics.")

    except Exception as e:
        print(f"!!! Failed to add metrics: {e}")

if __name__ == "__main__":
    add_metrics_to_dataset()
